 ...
 * @param {object} [opts]
 * @param {boolean} [opts.prompt=false]  Whether it may SHOW the browser
 *   permission dialog. Default false: the token is only fetched when the user
...
export const fetchToken = async (dispatch, { prompt = false } = {}) => {
  try {
