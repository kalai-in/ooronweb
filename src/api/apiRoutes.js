...
export const getUser = async ({ latitude, longitude } = {}) => {
  const params = {};
...
// General Api's
export const getZone = async ({ latitude, longitude, skipChannel = false }) => {
  ...
  const response = await api.get(apiEndPoints.getZone, { params, skipChannel });
  return response.data;
};
...
export const getCountriesWithDefault = async () => {
...
export const getCountrySetting = async ({ latitude, longitude } = {}) => {
  const params = {};
  if (latitude) params.latitude = latitude;
  if (longitude) params.longitude = longitude;
...
export const getDialCountries = async () => {
  const response = await api.get(apiEndPoints.getCountries);
  return response.data;
};
...
export const getPaymentSetting = async ({ latitude, longitude } = {}) => {
  const response = await api.get(
...
export const removeFromCart = async ({
  ...
  formData.append("is_remove_all", isRemoveAll ? 1 : 0);
...
// promocode api
export const getPromo = async ({ amount = 0, latitude, longitude }) => {
...
export const setPromoCode = async ({ promoCodeName, amount = 0, latitude, longitude }) => {
...
export const getEcomOrderDetail = async ({ orderItemId }) => {
...
export const downloadItemInvoice = async ({ orderItemId }) => {
  const formData = new FormData();
  formData.append("order_item_id", orderItemId);
...
export const addRecentlyViewedProduct = async ({ productId, latitude, longitude }) => {
  const formData = new FormData();
  formData.append("product_id", productId);
  if (latitude != null) formData.append("latitude", latitude);
  if (longitude != null) formData.append("longitude", longitude);
...
export const getRecentlyViewedProducts = async ({ productId, latitude, longitude }) => {
  const params = {
...
export const startAdminChat = async () => {
...
export const startOrderChat = async ({ order_id, order_item_id }) => {
  const formData = new FormData();
...
export const startOrderAdminChat = async ({ order_id }) => {
  const formData = new FormData();
  formData.append("order_id", order_id);
...
export const getChatMessages = async ({ conversation_id }) => {
