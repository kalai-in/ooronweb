...
const serverHeaders = ({ lang, channel }) => {
...
export const getHomeLayoutServer = async ({
  ...
  const params = { latitude, longitude, device };
 ...
 * routes exist.
 */
export const getSettingServer = async ({ lang } = {}) => {
...
const categoryTreeCache = new Map(); // key -> { data, expiresAt }
