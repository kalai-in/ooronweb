...
import { MAP_PROVIDERS, isSupportedProvider } from "./types";
 ...
 *
 * @param {import("./types").MapComponentProps & {
 *   provider?: import("./types").MapProvider
 * }} props
 */
export default function MapWrapper({ provider: providerProp, ...props }) {
