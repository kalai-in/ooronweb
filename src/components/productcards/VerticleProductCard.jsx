      ...
      >
        ...
        <div className="relative p-2">
          ...
          {hasDiscount && discountPercent > 0 && (
            <span
              className={`absolute top-4 z-10 w-40 transform-gpu [backface-visibility:hidden] primaryBackColor py-1.5 text-center text-[13px] font-bold uppercase leading-none tracking-wide text-white shadow-md ${rtl ? "-right-12 rotate-45" : "-left-12 -rotate-45"} ${closedDecorClass}`}
            >
