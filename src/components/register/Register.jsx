...
const Register = ({
  ...
  const registerConfirmationResultRef = useRef(null);
  ...
  const handlePhoneNumberChange = ({ dialCode, rawPhone: digits, fullNumber, lengthError }) => {
    setRawPhone(digits);
