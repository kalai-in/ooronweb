 ...
 *
 * @param {string}   code        applied promo code (e.g. "SAVE10")
 * @param {string}   savedAmount pre-formatted saved amount (e.g. "₹10.00")
 * @param {()=>void} onRemove    remove-coupon handler
 * @param {boolean}  loading     disables the remove button
 */
const AppliedCouponCard = ({ code, savedAmount, discountType, onRemove, loading }) => {
  const rtl = useIsRtl();
