...
const splitDuration = (remaining: number): DurationCell[] => {
...
export interface MaintanceModeProps {
  /** admin remark (`website_mode_remark`) */
  message?: string;
  /** `website_mode_end`, UTC datetime string */
  endAt?: string;
}
 ...
 */
const MaintanceMode = ({ message, endAt }: MaintanceModeProps) => {
