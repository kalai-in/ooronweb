...
const EcomOrdersList = ({ type, dateFilter }) => {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- resets pagination on filter/type change; not derivable from render
    setOffset(0);
    handleFetch(false, 0);
