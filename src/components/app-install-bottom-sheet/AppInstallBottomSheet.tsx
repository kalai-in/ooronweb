...
const isAndroidUA = (ua: string) => /android/i.test(ua);
const isIOSUA = (ua: string) =>
  /iPad|iPhone|iPod/.test(ua) && !(isBrowser() && (window as any).MSStream);
...
const isMobileDevice = (ua: string) => isAndroidUA(ua) || isIOSUA(ua);
